...
/* ============================================================
   Akash Parsaniya Portfolio – script.js
   ============================================================ */
...
function handleFormSubmit(e) {
    ...
    const mailto = `mailto:akash.parsaniya18@gmail.com?subject=${subject}&body=${body}`;
...
(function typeEffect() {
    ...
    if (!target) return;
    const roles = ['Java Backend Devloper', 'Spring Boot Devloper', 'Microservice Enthusiast', 'DSA & LeetCode Solver'];
